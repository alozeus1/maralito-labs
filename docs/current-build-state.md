...
| 0015 | Phase 8A mobile PWA private testing — **ACCEPTED (dev-only scope)**; 8A dev work **complete except the Row 11-gated device dry-run** (see `docs/phase-8/8a-final-dev-review.md`). Controlled Vercel preview deployed behind Deployment Protection (`docs/phase-8/8a-preview-deployment-evidence.md`, 2026-07-05); env/webhook/redirects remain owner actions. Tester round still gated on Phase 7 rows 11/18 + Row 19 activation |
