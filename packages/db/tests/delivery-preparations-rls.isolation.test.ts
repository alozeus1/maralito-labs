/**
 * Phase 6 (ADR-0012) — delivery_preparations RLS isolation on real Postgres (PGlite), applying the REAL
 * policies.sql + orders/quotes/payments/notifications/inspections/delivery-preparations policy files.
 * Customer own-read + staff org manage; history staff-only; no customer writes. Address-ref + window only.
 */
